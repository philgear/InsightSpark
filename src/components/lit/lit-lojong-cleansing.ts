...
@customElement('lit-lojong-cleansing')
export class LitLojongCleansing extends LitElement {
  ...
  override render() {
    return html`
      <div class="river-wrap ${this.chromeHidden ? 'chrome-hidden' : ''}">
...
declare global {
  interface HTMLElementTagNameMap {
    'lit-lojong-cleansing': LitLojongCleansing;
  }
}
